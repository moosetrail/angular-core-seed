/// <reference path="../../../src/Moosetrail.Angular.Core/Core/typings/angularjs/angular.d.ts" />
/// <reference path="../../../src/Moosetrail.Angular.Core/Core/typings/angularLocalStorage/angularLocalStorage.d.ts" />
/// <reference path="../../../src/Moosetrail.Angular.Core/Core/typings/jquery/jquery.d.ts" />
...
declare module Moosetrail.Core.DataAccess {
    class LocalDataFactory {
        ...
        private localStorage;
        static $inject: string[];
        constructor($q: ng.IQService, local: angular.localStorage.ILocalStorageService);
